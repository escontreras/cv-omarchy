...
export type Edu = { degree: string; school: string; location: string; dates: string };
...
export const TABS = [
  { id: 'resumen', es: 'resumen', en: 'summary', cmd: { es: 'cat resumen.md', en: 'cat summary.md' } },
  { id: 'skills', es: 'habilidades', en: 'skills', cmd: { es: 'ls -la skills/', en: 'ls -la skills/' } },
  { id: 'exp', es: 'experiencia', en: 'experience', cmd: { es: 'git log --oneline experiencia', en: 'git log --oneline experience' } },
  { id: 'edu', es: 'educación', en: 'education', cmd: { es: 'cat educacion.md', en: 'cat education.md' } },
  { id: 'contact', es: 'contacto', en: 'contact', cmd: { es: 'cat contacto.txt', en: 'cat contact.txt' } },
] as const;
...
export const CV: Record<Lang, LangData> = {
  es: {
    ...
    skillGroups: [
      { label: 'frameworks & librerías', items: ['React.js', 'React Native (Expo)', 'Next.js', 'NativeWind', 'Tailwind CSS', 'Redux', 'Zustand', 'TanStack Query', 'Zod'] },
      { label: 'ingeniería de software', items: ['TypeScript', 'JavaScript (ES6+)', 'Micro-Frontends', 'CI/CD', 'Jest'] },
      { label: 'ia & productividad', items: ['Claude Projects', 'Claude Code', 'Claude Design', 'Windsurf', 'Cursor', 'Prompt Engineering', 'Automatización'] },
      { label: 'herramientas & cloud', items: ['Git / GitHub', 'App Store Connect', 'Google Play Console', 'Agora SDK', 'Firebase'] },
    ],
    jobs: [
      {
        role: 'Tech Lead Front-End', company: 'Livehappy', location: 'Bogotá, Colombia', dates: 'Nov 2024 — Presente',
        bullets: [
      ...
      {
        role: 'Desarrollador de Software', company: 'Grupo Centria', location: 'Panamá (Remoto)', dates: 'Nov 2022 — Nov 2024',
        bullets: [
      ...
      {
        role: 'Desarrollador de Software (Freelance)', company: 'Independiente', location: 'San Cristóbal, Venezuela', dates: 'Ago 2020 — Nov 2022',
        bullets: [
    ...
    edu: { degree: 'Ingeniería en Informática', school: 'Universidad Nacional Experimental del Táchira (UNET)', location: 'San Cristóbal, Venezuela', dates: '2014 — 2023' },
    certs: ['Escuela de Desarrollo Web — Platzi (2019)', 'Configuración e Instalación de Redes — CISCO / UNET (2018)'],
    langsLine: 'Español: Nativo · Inglés: B1 (Competencia profesional)',
    certsLabel: 'certificaciones', langsLabel: 'idiomas', downloadLabel: 'Descargar CV (PDF)',
  },
  en: {
    role: 'Front-End Lead',
    loc: 'Cúcuta, Colombia',
    ...
    skillGroups: [
      { label: 'frameworks & libraries', items: ['React.js', 'React Native (Expo)', 'Next.js', 'NativeWind', 'Tailwind CSS', 'Redux', 'Zustand', 'TanStack Query', 'Zod'] },
      { label: 'software engineering', items: ['TypeScript', 'JavaScript (ES6+)', 'Micro-Frontends', 'CI/CD', 'Jest'] },
      { label: 'ai & productivity', items: ['Claude Projects', 'Claude Code', 'Claude Design', 'Windsurf', 'Cursor', 'Prompt Engineering', 'Automation'] },
      { label: 'tools & cloud', items: ['Git / GitHub', 'App Store Connect', 'Google Play Console', 'Agora SDK', 'Firebase'] },
    ],
    jobs: [
      {
        role: 'Front-End Tech Lead', company: 'Livehappy', location: 'Bogotá, Colombia', dates: 'Nov 2024 — Present',
        bullets: [
      ...
      {
        role: 'Software Developer', company: 'Grupo Centria', location: 'Panama (Remote)', dates: 'Nov 2022 — Nov 2024',
        bullets: [
      ...
      {
        role: 'Software Developer (Freelance)', company: 'Independent', location: 'San Cristóbal, Venezuela', dates: 'Aug 2020 — Nov 2022',
        bullets: [
    ...
    edu: { degree: 'Computer Engineering', school: 'Universidad Nacional Experimental del Táchira (UNET)', location: 'San Cristóbal, Venezuela', dates: '2014 — 2023' },
    certs: ['Web Development School — Platzi (2019)', 'Network Setup & Installation — CISCO / UNET (2018)'],
    langsLine: 'Spanish: Native · English: B1 (Full professional proficiency)',
    certsLabel: 'certifications', langsLabel: 'languages', downloadLabel: 'Download CV (PDF)',
  },
};
